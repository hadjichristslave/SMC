...
\begin{equation} \label{Gibbs}
  ...
  \subsection{Complexity}
    ...
    \begin{thebibliography}{99} % Bibliography - this is intentionally simple in this template
        ...
        \bibitem{ekf} \newblock Bailey, T., Nieto, J., Guivant, J., Stevens, M., \& Nebot, E. (2006, October). Consistency of the EKF-SLAM algorithm. In Intelligent Robots and Systems, 2006 IEEE/RSJ International Conference on (pp. 3562-3568). IEEE.  \bibitem{graph}
